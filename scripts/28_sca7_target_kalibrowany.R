# Poprawka do 27_: prog osi Aldoc uczony na WT (mediana), stosowany do SCA7.
# Bez przerzedzania - uzywamy pelnej glebokosci, ale tylko komorek powyzej progu UMI,
# i osobno kontrolujemy glebokosc przez dopasowanie WT/SCA7.
...
kand <- c("Cux2","Cpne9","Wscd2","Camk2d","Sorcs2","Mpped2","Kctd12","Corin","Lhx5","Ebf2","Aldoc","Plcb4")
