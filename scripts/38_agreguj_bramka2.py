...
GEN={1574:"Nup214",6597:"Cux2",8856:"Nr2f2",9855:"Ranbp2",11154:"Nup93",11963:"Ebf2",14472:"Prkca",16199:"Zfpm2",17112:"Zbtb20",18537:"Lmnb1"}
...
nline=0
with open("/mnt/data1t/pc_rebuild/geny_atlas2.tsv") as fh:
    for line in fh:
        a,b,v=line.split()
        c=int(b); t=typ[c]
        if t==0: continue
...
T.to_csv(f"{P}/processed/specyficznosc_bramka2.csv",index=False)
pd.set_option("display.width",260)
print(f"\n=== EKSPRESJA W {len(T)} TYPACH KOMOREK ATLASU (suma {T.n_komorek.sum()} jader) ===")
print(T[["typ","n_komorek","Ranbp2_cp10k","Ranbp2_pct","Nup93_cp10k","Lmnb1_cp10k",
         "Cux2_cp10k","Cux2_pct","Ebf2_cp10k","Ebf2_pct","Zbtb20_cp10k","Zfpm2_cp10k"]].to_string(index=False))
...
print(f"\nzapisano processed/specyficznosc_bramka2.csv")
